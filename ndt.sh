...
#  URL: https://github.com/wildyverando/ndt.git
#
# -----------------------------------------------------------------------------
#
...
function main() {
    ...
    echo "==========================================================================="
    echo " Author  : Wildy Sheverando <wildy@wildyverando.com>"
    echo " Date    : 30-09-2023"
    echo " Version : 1.0.0"
    echo " Release : Stable"
    echo " License : https://github.com/wildyverando/ndt.git"
    echo "==========================================================================="
    echo ""
